...
module.exports.run = function({ api, event, args, getText }) {
  const fs = require("fs-extra");
    ...
    let i = 0;
    let msg = "≻───𝐷𝑎𝑛ℎ 𝑠𝑎́𝑐ℎ 𝑙𝑒̣̂𝑛ℎ 𝑏𝑜𝑡 𝙉𝙜𝘿𝙪𝙮𝙏𝙪𝙖𝙣───≺\n\n";
