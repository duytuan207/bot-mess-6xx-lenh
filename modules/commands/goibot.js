...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["chào bạn tôi là bot của Tuấn đz", "Gọi tui có gì hong", "Shao zạ", "Hi, chào cậu :3", "Shao nè", "Sử dụng _callad để liên lạc với admin!", "Em là bot cute nhất hành tinh", "Nói gì thế con lợn", "Em đây~~~~", "hello...", "What'up bro", "Sao thế công chúa", "Ahihi chào cậu", "Trả 5 chục", "Cậu có cô đơn hong , có thì kệ mie cậu đồ kh có ngiu :>>", "Cho mượn 5 chục đi", "bot dthw như chủ của bot ạ", "Gì zạ" ,"Chuyện gì đó", "Đừng spam Pò nha :<<","", "Pòooooooooooooooooo", "get low , get low", "Spam cút đy", "Mệt -,-", "Nói đi , sao?", "chào bạn tôi là bot của Tuấn", "Bạn có biết tôi yêu bạn vai lon", "M ko bt là t là đại ca tịnh thất bồng lai à hoho", "Vợ gọi có việc gì không?", "Sử dụng callad để liên lạc với admin!", "Em là bot cute nhất hành tinh", "Chúa phù hộ em", "Em đây~~~~", "Yêu anh Tuấn nhất", "Đi giải cứu Diễm Mi nàooo", "Gọi tao lm gì sủa lẹ", "Sao thế công chúa","mô phật", "Tuyển phi công ạ", "Làm bồ em ko ạ? dui lắm", "Cậu cô đơn ko?", "Tuyển ghệ đít bự đi bay lắc", "Được của ló :)))", "Mong thí chủ đừng spam có đc hog hả", "Đừng khen em ngại quá hí hí", "Làm chồng em ko ạ?", "Đừng spam em nha :<<", "Bằng lái hủ tiếu kinh nghiệm đầy minh tuyển ghệ đít bự", "Tịnh tâm", "Omg yêu mọi người <3", "Mik đang ế ai hốt yêu lun 😼", "Chồng em đây rồi", "Nứng à kiu hoài", "Mik Hog Tồi Nhoaaa", "ăn cuk hog mà kiu", "hỏ ai kiu bot dọ"];
  ...
  if ((event.body.toLowerCase() == "2004")) {
 ...
 if ((event.body.toLowerCase() == "M hát đi ") || (event.body.toLowerCase() == "m đi bot")) {
  ...
  if ((event.body.toLowerCase() == "Bạn tuấn") || (event.body.toLowerCase() == "bạn Tuấn")) {
