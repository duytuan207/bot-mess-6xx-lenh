...
❎ Tuổi: 14
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m62 x 62
💘 Mối quan hệ: 0 có ai tán đi
🌎 Quê quán: Ninh Bình
🌸 Tính cách: Lúc vui lúc buồn
🌀 Sở thích: Chơi game, xem phim anime blabla, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo:0972260366
🌐 Facebook: https://www.facebook.com/100041161539665
✉️ Email: hiearth92@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100041161539665}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
...
if (args[0] == "user") { 
    ...
    var gender = sex == 2 ? "Nam" : sex == 1 ? "Nữ" : "Trần Đức Bo";
    var callback = () => api.sendMessage({body:`😚Tên: ${name}` + `\n🏝URL cá nhân: ${url}` + `\n💦Tên người dùng: ${sn}\n🐧UID: ${args[1]}\n🦋Giới tính: ${gender}\n❄️Kết bạn bot: ${b}`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID);   
       return request(encodeURI(`https://graph.facebook.com/${args[100021950671640]}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback());
    }
     }
