 module.exports.config = {
  ...
  description: "tự động cấm người dùng nếu spam bot 2 lần/100s",
...
module.exports. run = ({api, event, args, Users,Threads}) => {
  return api.sendMessage("📣Tự động cấm người dùng nếu 2 lần/1 phút✅", event.threadID, event.messageID);
};
